        ...
        <div className="flex flex-col border border-gray-200 rounded-lg overflow-hidden h-full">
            <div className="flex flex-col h-full p-6">
                ...
                <div className="flex flex-row justify-between mb-4 h-5">
                    ...
                    <span className="text-zinc-600 text-sm">Posted by {post.author}</span>
                </div>
                ...
                <div className="flex flex-col flex-grow min-h-0">
                    ...
                    <header className="h-14 mb-4">
                        <Link
                            href={`/blog/${post.slug}`}
                            className="text-xl font-bold tracking-tight hover:opacity-80 line-clamp-2 block"
                        >
                            {post.title}
                        </Link>
                    </header>
                    ...
                    <div className="flex-grow min-h-0 mb-6">
                        <p className="text-zinc-600 line-clamp-3">{post.excerpt}</p>
                    </div>
