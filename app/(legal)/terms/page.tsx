            ...
            <div className="max-w-4xl mx-auto px-6 py-16">
                ...
                <div className="prose prose-lg max-w-none">
                    ...
                    <p>
                        ...
                        and the subscription to, the Website and/or the {COMPANY_NAME}
                        Platform provided by {COMPANY_NAME}. By accessing the Website and/or the
                        {COMPANY_NAME} Platform or by the Parties signing or accepting the present
                        agreement, you agree to the General Terms on behalf of yourself as a User
                        and/or, as the case may be, on behalf of the organisation that you represent
                    ...
                    <ul className="list-disc pl-6 mb-4">
                        <li>
                            ...
                            to Subsignal in conjunction with the Services
                        </li>
                        <li>
                            &ldquo;Effective Date&rdquo; means the first date a User accessed the
                            Website or the Subsignal Platform
                        </li>
                        <li>
                            &ldquo;Subsignal Platform&rdquo; means the platform commercialized by
                            Subsignal
                        </li>
                        <li>
                    ...
                    <p>
                        During the Term, Subsignal grants to Customer and its Users the right to
                        access and use the Subsignal Platform, and any related services, in
                    ...
                    <p>
                        In consideration for the Services, Customer shall pay Subsignal the fees
                    ...
                    <p>
                        Subsignal shall store and process Customer Data in accordance with our
                    ...
                    <ul className="list-disc pl-6 mb-4">
                        ...
                        <li>
                            By Subsignal if Customer fails to make any payment within 15 days after
                            notice
                        </li>
                    </ul>
