        ...
        <div className="min-h-screen bg-white">
            <div className="max-w-4xl mx-auto px-6 py-16">
                ...
                <div className="prose prose-lg max-w-none">
                    ...
                    <p>
                        At {COMPANY_NAME}, we are committed to protecting your privacy and personal
                    ...
                    <p>
                        This Privacy Policy applies to all personal information that
                        {COMPANY_NAME} collects, uses, and discloses in the course of providing our
                        services. This includes information collected through our website, platform,
                    ...
                    <ul className="list-disc pl-6 mb-4">
                        ...
                        <li>Email conversations and platform interactions</li>
