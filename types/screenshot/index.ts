...
export type BlockResourceType = (typeof BlockableResources)[keyof typeof BlockableResources];
...
export type LiveScreenshotResult = {
    // htmlContent is the HTML content of the page.
    htmlContent: string;
    // imageContent is the image content of the page.
    imageContent: Buffer;
};

// ArchiveScreenshotResult is the result of an archive screenshot.
export type ArchiveScreenshotResult = {
    // htmlContent is the HTML content of the page.
    htmlContent: string;
};
